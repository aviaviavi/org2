...
export function buildOrg2CapabilityManifest(): Org2CapabilityManifest {
  return {
    ...
    workflows: [
      ...
      {
        id: "planning",
        purpose: "Build agendas, inspect the unified run/headline approval queue, and mutate corpus-default and file-defined TODO workflows (active and terminal states), list checkboxes, planning, effort, habit, and clock state.",
