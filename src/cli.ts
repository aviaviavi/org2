...
const DEFAULT_SYNTAX_HEAD_INCLUDES = [
  ...
  '<style>:root[data-theme="light"] code[class*="language-"],:root[data-theme="light"] pre[class*="language-"]{color:#1f2937!important;} :root[data-theme="light"] .token.punctuation,:root[data-theme="light"] .token.operator,:root[data-theme="light"] .token.plain,:root[data-theme="light"] .token{color:#374151!important;} @media (prefers-color-scheme: light){:root:not([data-theme]) code[class*="language-"],:root:not([data-theme]) pre[class*="language-"]{color:#1f2937!important;} :root:not([data-theme]) .token.punctuation,:root:not([data-theme]) .token.operator,:root:not([data-theme]) .token.plain,:root:not([data-theme]) .token{color:#374151!important;}}</style>',
