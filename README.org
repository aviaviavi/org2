...
Status legend:
- *Available now*: usable today in the current CLI/editor workflow.
- *In progress*: implemented in part, but still evolving.
...
- Babel-style code execution workflows: *Planned*
- Capture/refile/clocking ecosystem parity: *Planned*
