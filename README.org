...
and performance validation. Both paths assemble and verify a complete staged
...
release* under its audio/runtime settings, and the bundle records the same mode
as =Org2BuildConfiguration= in =Info.plist=.
