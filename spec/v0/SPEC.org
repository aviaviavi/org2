...
- structural blocks (e.g. =#+begin_src= ... =#+end_src=, or =#+begin_org2= ... =#+end_org2=)
...
- A begin line matching =#+begin_src= or =#+begin_org2= (case-insensitive), with optional indentation.
- Zero or more body lines (treated as raw text).
- An end line matching =#+end_src= or =#+end_org2= (case-insensitive), with optional indentation.
