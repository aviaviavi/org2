...
- A native =org2-lifecycle= OpenClaw plugin that correlates substantial main-agent turns, subagents, and cron executions with durable Run Center records, preserves runtime metadata and outcome summaries, keeps approval boundaries open until a decision, continues approved workflows in their existing chat session, verifies the Mac app's selected corpus identity, and reconciles active Org2 schedules into OpenClaw cron
