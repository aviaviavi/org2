...
Org2 Workspace is the product direction for focused clients over the same local corpus. Agenda review, entity pages, meeting memory, search, OpenClaw threads, and data-backed reports should all use parser/compiler output instead of private app state.
