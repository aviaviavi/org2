...
- Reusable, versioned workflow packages with parameters, capability and risk declarations, validation, approval boundaries, schedules, file-change/capture/meeting triggers, packaging metadata, and a built-in meeting-to-controlled-execution recipe
...
- A native =org2-lifecycle= OpenClaw plugin that correlates substantial main-agent turns, subagents, and cron executions with durable Run Center records
