...
- Org-crypt subtree encryption/decryption workflows, including multi-recipient encryption for shared user/device/agent access without putting the plaintext in a vendor database
