...
The next major app milestone should deepen *capture routing and refiling*: refile into existing files/headings, add effort and richer templates at capture time, and preserve clean Org2 source throughout. Meeting-to-action, knowledge-browser, broader data-source configuration, and packaging/first-run work can proceed in parallel, landing in their natural product surfaces.
