...
To connect one, open *Org2 Workspace → Settings… → AI Chat*. Enable or add a destination such as local Codex, remote Codex, or OpenClaw. An AI thread can then search the corpus, cite the files it used, and—within the permissions you choose—preview or apply edits.
