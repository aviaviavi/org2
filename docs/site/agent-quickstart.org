...
- *Refresh external mirrors*: =source list/doctor/bind/sync= orchestrates =slacrawl= and =notcrawl=. Portable profiles contain no secrets; every machine supplies its own binding outside the corpus.
