...
- Keep Markdown for simple public prose where plain docs are enough.
- Use Org2 for personal/work operating systems: tasks, planning, linked notes, and structured publishing.
