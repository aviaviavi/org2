...
This roadmap builds on the concrete [[file:corpus-flow.org][corpus flow and trust boundaries]]. Compilation remains the foundation. Agent runs turn compiled knowledge into controlled outcomes.
