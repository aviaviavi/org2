...
Org2 should not compete by being a slightly nicer Markdown editor. Markdown is already good for plain prose.
...
- provenance makes generated artifacts inspectable instead of mysterious
...
- publishing docs that explain the corpus model instead of only listing editor features
