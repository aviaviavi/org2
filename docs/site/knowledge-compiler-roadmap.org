...
The next product layer is described in the [[file:agentic-workspace-roadmap.org][agentic workspace roadmap]]: durable agent runs, reusable workflows, review and approval surfaces, finished artifact pipelines, provider portability, and multiplayer work over the same compiler-backed corpus.
