...
org2 run create --goal "Resolve the customer issue" \
  --agent-ref scarf-support --goal-ref customer-trust --dir ~/notes
org2 todo assign --file notes/support.org2 --line 12 --assignee "Scarf Support" \
  --agent-ref scarf-support --goal-ref customer-trust --apply
#+end_src
