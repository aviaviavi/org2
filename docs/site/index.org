...
<div class="org2-shot-grid">
  ...
  <figure><img src="assets/screenshots/macos-workspace-brief.png" alt="Org2 Workspace Agent Space showing a generated Beacon Launch node brief with provenance" loading="lazy" /><figcaption>Agent Space: generated briefs, source refs, review state, and next actions stay inspectable before promotion.</figcaption></figure>
  <figure class="org2-shot-phone"><img src="assets/screenshots/ios-mobile-agenda.png" alt="Org2 Mobile agenda on iPhone showing synced launch tasks" loading="lazy" /><figcaption>Mobile agenda: review and triage synced corpus tasks from the phone.</figcaption></figure>
</div>
#+END_EXPORT
