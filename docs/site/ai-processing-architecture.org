...
The first implemented slice is provider-free manifest validation; see [[file:ai-job-manifests.org][AI job manifests]] and =spec/v0/ai-job-manifest.schema.json=.
...
- adapter interfaces and mock adapters
