...
5. Write a generated artifact under =views/= or =compiled/= with =ORG2_ARTIFACT_ROLE=, =ORG2_PROVENANCE=, =ORG2_GENERATOR=, =ORG2_GENERATED_AT=, and review status metadata.
