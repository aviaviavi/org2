...
The app remembers the visible source line for each file and shares it across reading and source editing. Choosing *Edit* from a rendered document or compiled slide deck opens the editor at the source line nearest the current viewport or slide; closing the editor, changing document scope, navigating away and back, or reopening the app restores that file near the same place instead of returning to the top.
