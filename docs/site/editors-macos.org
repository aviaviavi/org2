...
When you choose *Edit* from a rendered document or compiled slide deck, the source editor opens at the source line nearest the current viewport or slide instead of returning to the top of the file.
