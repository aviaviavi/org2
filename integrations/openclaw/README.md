...
and reconciles active schedule triggers from visible `workflows/*.org2` files
into OpenClaw cron. Stable OpenClaw keys are persisted on Org2 runs for
correlation and deduplication. Ordinary conversation and personal TODOs are not
promoted into runs.
